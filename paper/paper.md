...
Другими словами, B-сплайн-функция порядка k может быть получена путем свертки B-сплайн функции порядка 0 с самой собой k раз, на рис. 1 показано несколько B-сплайн. Это известное свойство свертки B-сплайнов, которое будет использоваться для выполнения интерполяции B-сплайнов. 
